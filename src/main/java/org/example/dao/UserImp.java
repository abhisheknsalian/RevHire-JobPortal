...
public class UserImp implements User {
    ...
    public static  UserImp getJobSeekerInstance(Connection connection) {//factory method
        if (instance == null) {
                ...
                case 1:
                    ...
                    if (jobOpenings.isEmpty()) {
                        ...
                        for (JobOpeningModel emp : jobOpenings) {
                            System.out.println("Job-ID--> " + emp.getJobId() + " Company-Name--> " + emp.getCompanyName() + " Job-Role--> " + emp.getJobRole() + " Job-Location--> " + emp.getJobLocation() + " Package--> " + emp.getPackageAmount() + " Job-Description--> " + emp.getJobDescription() + " No.Of-Positions--> " + emp.getNoOfPositions() + " Years-Of-Experience--> " + emp.getYearsOfExperience() + " Posted-By--> " + emp.getEmployeeId());                    }
                    }
